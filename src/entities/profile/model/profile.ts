...
export const profile = {
  ...
  experience: 9,
  bio: [
    "AI-native Full Stack engineer with 9 years scaling startups to tens of millions in revenue. Power user of Claude Code, OpenAI Codex, GitHub Spec Kit, and OpenAI APIs-helping teams adopt AI development workflows.",
